""" Remixed from:
    github.com/xinntao/BasicSR/blob/master/metrics/calculate_PSNR_SSIM.py """
import os
import math
import numpy as np
import cv2
...
def main():
    ...
    folder_GT = "/volume1/transfer/Optometer/ESRGAN-GroundTruth"
    folder_Gen = "/volume1/transfer/Optometer/ESRGAN-Output"
    ...
    for i, img_path in enumerate(img_list):
        ...
        im_Gen = (
            cv2.imread(os.path.join(folder_Gen, base_name + suffix + ".png"))
            / 255.0
        )
        ...
        print(
            "{:3d} - {:25}. \tPSNR: {:.6f} dB, \tSSIM: {:.6f}".format(
